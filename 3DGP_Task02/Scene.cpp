...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[9].BaseShaderRegister = 17; //t17: gtxtWaterBaseTexture, t18: gtxtWaterDetailTexture, t19: gtxtWaterDetailAlphaTexture
	...
	pd3dRootParameters[12].DescriptorTable.pDescriptorRanges = &pd3dDescriptorRanges[9];	//water
	...
	pd3dRootParameters[13].Constants.Num32BitValues = 16;	//Texture Animation (4x4) Matrix
	pd3dRootParameters[13].Constants.ShaderRegister = 3;	//
	...
	pd3dRootParameters[14].DescriptorTable.pDescriptorRanges = &(pd3dDescriptorRanges[10]);	//billbord
...
void CScene::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	pd3dCommandList->SetGraphicsRoot32BitConstants(13, 16, &xmf4x4WaterAnimation, 0);
}
